...
@section('section-title', "Update $section -> " . $menuItem->title)
    ...
    <div class="row">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <!-- form start -->
                    <form role="form" method="POST" action="{{ route("$section.update", ['menu_item' => $menuItem->id]) }}" enctype="multipart/form-data">
                        @method('PATCH')
