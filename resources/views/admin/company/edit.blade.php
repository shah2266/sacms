@php $section = 'company' @endphp
@extends('layouts.admin')
@section('title', $section)

@section('section-title', "Update $section -> " . $company->company_name)
    ...
    <div class="row">
        ...
        <div class="col-lg-12 grid-margin">
            <div class="float-right">
                <a
                    ...
                    href="{{ URL::to("admin/site-settings/$section") }}">
                    Back
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <!-- form start -->
                    <form role="form" method="POST" action="{{ route("$section.update", [$section => $company->id]) }}" enctype="multipart/form-data">
                        @method('PATCH')
